...
# Clean the dataset to ensure the forest only sees true predictors, drop the prediction columns generated during the Cox evaluation
rsf_data <- final_model_data_path %>%
  select(-any_of(c("risk_score", "pred_surv", "decile")))

# Define the time horizon (same as before)
